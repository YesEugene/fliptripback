    ...
    try {
      ...
      if (dbResult.success && dbResult.locations && dbResult.locations.length > 0) {
        ...
        return {
          ...
          rating: 4.5,
          priceLevel: dbLocation.price_level !== null && dbLocation.price_level !== undefined ? dbLocation.price_level : 2,
          website: dbLocation.website || null,
          phone: dbLocation.phone || null,
          bookingUrl: dbLocation.booking_url || null,
          source: dbLocation.source || 'admin',
          googlePlaceId: dbLocation.google_place_id || null,
    ...
    try {
      ...
      if (response.data.results.length > 0) {
        ...
        return {
          ...
          bookingUrl: place.booking_url || null,
          source: 'google',
