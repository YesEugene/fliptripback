/**
 * Simple script to update tours directly
 * Run with: node scripts/update-tours-direct-simple.js
...
// Quality tour data - just 2 tours for now to test
const qualityTours = [
  {
    city: 'Paris',
    country: 'France',
...
async function main() {
  ...
  console.log(`Created/Updated: ${createdTours.length}`);
  if (errors.length > 0) {
